...
export default function RegisterToolScreen() {
  ...
  const handleRegister = () => {
    console.log('Registrar Ferramenta/Máquina: ' + toolName);
    router.back();
  };
  ...
  return (
    ...
    >
      <Header title="Cadastrar Ferramenta" />
      <View
        style={[
          styles.container,
      ...
      >
        ...
        >
          Controle de Cadastros de Ferramentas
        </Text>
        ...
        >
          ...
          >
            <LabelledInput
              label="NOME DA FERRAMENTA/MÁQUINA"
              required
              value={toolName}
              onChangeText={setToolName}
            />

            <LabelledInput label="TIPO" required />
            <LabelledInput label="STATUS" required />
            <LabelledInput
